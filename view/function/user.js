...
async function actualizarUsuario() {
  const datos = new FormData(document.querySelector("#frm_edit_user"));
...
async function eliminar(id) {
  ...
  json = await respuesta.json();
  if (!json.status) {
    alert("Ooooops, ocurrio un error al eliminar persona,intentelo mas tarde");
    console.log(json.msg);
    return;
  } else {
    alert(json.msg);
