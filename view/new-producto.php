...
<div class="container-fluid">
    <div class="card">
        ...
        <form id="frm_producto" action="<?= BASE_URL ?>control/ProductoController.php?tipo=registrar" method="POST" enctype="multipart/form-data">
            <div class="card-body">
...
<script>
    cargarProveedores(); // Primero cargamos proveedores
    cargarCategorias(); // Primero cargamos categorías
</script>